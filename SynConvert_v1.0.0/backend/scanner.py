...
def _validate_root(root: Path, output_dir: str | Path | None) -> None:
    ...
    if output_dir is not None:
        ...
        # Also guard against output being a subdirectory of input
        try:
            output_resolved.relative_to(root)
            # If we reach here, it means output is inside root
            raise ValueError(
            ...
            # This is GOOD: output is NOT inside root
            pass
