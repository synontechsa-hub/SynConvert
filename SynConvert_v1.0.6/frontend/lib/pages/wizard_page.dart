...
class _WizardPageState extends State<WizardPage> with AutomaticKeepAliveClientMixin {
          ...
          child: Column(
            ...
            children: [
              ...
              if (_inputPath == null)
                ...
                Expanded(child: _buildConversionLog(context))
              else if (_proposals != null)
                Expanded(child: _buildProposalTable(context))
              else
                _buildReadyToScanView(context),
            ],
          ),
        ),
      ),
  ...
  Widget _buildReadyToScanView(BuildContext context) {
    return Expanded(
      child: Center(
        child: Column(
  ...
  Widget _buildProposalTable(BuildContext context) {
    return Column(
      children: [
        // Header row
        Row(
  ...
  Widget _buildConversionLog(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
